window.LAU_MANUAL_DATA = {
  mechanicsReaderText: `2026 Umpires Manual
SECTION 1 CREW OF TWO BASIC PRINCIPLES
Angle is primary and distance is secondary. With only two umpires, work to get the best angle to make the call. The plate umpire will move to help on pulled-foot and swipe-tag plays, slides at second base, and plays at third base. Pause, read and react before going out on trouble balls. If you go out, go out hard and leave no doubt for your partner.

SECTION 2 NO RUNNERS ON
Initial Position: U1 is in the A position. PU has responsibility for balls up to first base and all balls along the third-base line. U1 has responsibility for balls that hit first base and/or go beyond. On routine and pressure ground balls to first, PU moves toward first to assist on pulled-foot or swipe-tag plays and to observe potential running-lane interference. U1 moves into the best position for the play at first. On overthrows with no runners on, PU has the overthrow unless U1 has gone out and rotates home. On clean hits to the outfield, PU has plays on the batter-runner into third base, while U1 handles the batter-runner at first and second.

SECTION 3 RUNNER ON FIRST
Initial Position: U1 starts in the B position. PU keeps all fair/foul responsibility and all foul-fly responsibility. U1 has no foul-line fair/foul responsibility. PU has catches by the pitcher moving in, the third baseman moving back or toward the line, and the first baseman moving back or toward the line. U1 has catches by infielders moving toward the middle, the shortstop in all directions, the second baseman in all directions, and the corner infielders moving in. On a clean hit to the outfield with a play on R1 at third, PU moves halfway toward third, reads the throw, and takes the play at the third-base cutout. If PU stays on the right-field line for fair/foul or catch/no catch, U1 must take all plays at first, second and third.

SECTION 4 RUNNERS ON FIRST AND SECOND
Initial Position: U1 starts in the C position. With runners on first and second, PU still has all fair/foul responsibility and foul flies. U1 has outfield coverage in the V and plays at any base except home on base hits. On a clean hit to the outfield, PU observes R2 at the plate and R1 at third, while U1 handles base touches and plays on the bases. On a caught fly ball to center field with a throw to third, PU moves halfway up the line and takes the play at third on R2 when needed. If PU is on the right-field line, U1 must cover the bases.

SECTION 5 BASES LOADED
Initial Position: U1 starts in the C position. PU is responsible for the pitch, all fair/foul calls, fly balls in PU's outfield area, R3's tag at third on a fly ball, and plays at the plate. U1 is responsible for pickoff attempts at any base, stolen-base attempts by R1 or R2, fly balls in U1's area, and plays at any base on batted balls. On a clean hit to the outfield, PU stays with touches and plays at the plate, while U1 has the batter-runner's touch of third and other base responsibilities.

SECTION 6 RUNNERS ON FIRST AND THIRD
Initial Position: U1 starts in the B position. Because so much can happen, staying in B is best. U1 must not overcommit on throws to first because the defense may snap to third or home. On steals and trick plays, U1 watches the initial throw and keeps options open for the next play. On a fly ball down the right-field line with no catch, PU may move toward first for fair/foul and catch/no catch before returning toward the plate, while U1 stays prepared to take the bases.

SECTION 7 RUNNER ON SECOND
Initial Position: U1 starts in the C position. On clean hits with a play developing at third, PU reads the runner and throw and moves into the third-base cutout when the ball and runner will arrive together. U1 observes base touches at first and second and stays with the batter-runner if BR advances toward third. On plays within the infield, U1 moves into position for all plays at first, second or third. On caught fly balls, U1 observes R2's tag and takes the bases.

SECTION 8 RUNNERS ON SECOND AND THIRD
Initial Position: U1 starts in the C position and may work a step or two deeper. PU is responsible for the pitch, fair/foul, fly balls in PU's outfield area, R3's tag at third on a fly ball, R2's touch of third if R2 attempts to score, and any runner touching the plate. U1 is responsible for pickoff attempts at second or third, stolen-base attempts by R2, fly balls in U1's area, and plays at any base involving R2 or the batter-runner. On clean hits to the outfield, U1 remains responsible for plays involving BR, including a return throw to first.
...
`,
  mechanicsByQuestion: {
    "77": {
      ...
      text: "Initial Position: U1 is in the A position."
    },
    "78": {
      reference: "2026 Umpires Manual · Crew of Two · Runner on First · p. 74",
      text: "Initial Position: U1 will start in the B position."
    },
    "79": {
      reference: "2026 Umpires Manual · Crew of Two · Runners on First and Third · p. 96",
      text: "Initial Position: U1 will start in the B position."
    },
    "80": {
      reference: "2026 Umpires Manual · Crew of Two · Runner on Second · p. 100",
      text: "Initial Position: U1 will start in the C position."
    },
    "81": {
      reference: "2026 Umpires Manual · Crew of Two · Bases Loaded · p. 89",
      text: "Initial Position: U1 will start in the C position."
    },
    "82": {
      reference: "2026 Umpires Manual · Crew of Two · Basic Principles · p. 60",
      text: "Angle is primary and distance is secondary. Work to get the best angle to make the call."
    },
    "83": {
      reference: "2026 Umpires Manual · Crew of Two · Basic Principles / Fair-Foul Coverage · pp. 60-61",
      text: "With no runners on base and U1 goes out, U1 would return to the plate for any play on the batter-runner there after ruling no catch, fair/foul and when no more trouble exists."
    },
    "84": {
      reference: "2026 Umpires Manual · Crew of Two · No Runners On · Infield Catch Coverage · p. 64",
      text: "U1 has catches by the first baseman moving left or out, the second baseman moving out or toward first base, the shortstop moving toward second base, and the pitcher moving back."
    },
    "85": {
      reference: "2026 Umpires Manual · Crew of Two · No Runners On · Fair/Foul Coverage · p. 61",
      text: "PU has responsibility for balls up to first base and all balls along the third-base line. U1 has responsibility for balls that hit first base and/or beyond."
    },
    "86": {
      reference: "2026 Umpires Manual · Crew of Two · No Runners On · Routine / Pressure Ground Ball · pp. 66-67",
      text: "PU moves toward first base to assist U1 on swipe-tag or pulled-foot plays and will also watch for potential running-lane interference."
    },
    "87": {
      reference: "2026 Umpires Manual · Crew of Two · No Runners On · Clean Hit / Extra-Base Hit to the Outfield · pp. 68-69",
      text: "On clean hits and extra-base hits with no runners on, U1 enters the infield and prepares for plays on the batter-runner, including taking the batter-runner into third when needed."
    },
    "88": {
      reference: "2026 Umpires Manual · Crew of Two · Runner on First · Infield Catch Coverage · p. 74",
      text: "U1 has catches by all infielders moving toward the middle of the field, by the shortstop moving in all directions, by the second baseman moving in all directions, and by the third and first basemen moving in."
    },
    "89": {
      reference: "2026 Umpires Manual · Crew of Two · Runner on First · Fair/Foul Responsibilities · p. 73",
      text: "PU has responsibility for all balls on both the first- and third-base lines and all foul-fly balls. U1 has no fair/foul responsibility down foul lines."
    },
    "90": {
      reference: "2026 Umpires Manual · Crew of Two · Runner on First · Base Hit to the Outfield · p. 78",
      text: "On a clean hit to the outfield with R1 advancing to third, PU reads R1 and the throw, communicates the play at third, and moves into the cutout for that play. U1 works the infield and has first and second."
    },
    "91": {
      reference: "2026 Umpires Manual · Crew of Two · Runner on First · Fly Ball to Right Field, No Catch, PU Stays on the Line · p. 79",
      text: "PU must communicate to U1 that PU is 'on the line' and will not have normal rotation coverage."
    },
    "92": {
      reference: "2026 Umpires Manual · Crew of Two · Runner on First · Rotation / Overthrow Coverage · pp. 78-79",
      text: "When PU rotates for a play at third and a subsequent overthrow develops, PU retreats toward home for any play at the plate, using a path that keeps the play in front and maintains angle."
    },
    "93": {
      reference: "2026 Umpires Manual · Crew of Two · Runner on First · Fly Ball Coverage · pp. 78-79",
      text: "On a fly ball down the left-field line, PU works the third-base line area and is prepared to rotate to third if there is a play on R1 there."
    },
    "94": {
      reference: "2026 Umpires Manual · Crew of Two · Runners on First and Second · Fly Ball to Center Field, Catch · p. 86",
      text: "When R2 tags and draws a throw to third, PU moves halfway up the line and takes the play at third when needed rather than simply staying home."
    },
    "95": {
      reference: "2026 Umpires Manual · Crew of Two · Runners on First and Second · Fly Ball to Right Field, Catch · p. 87",
      text: "If PU is on the line, U1 has the plays on the bases. PU is not still responsible for the play at third once PU has committed to line coverage."
    },
    "96": {
      reference: "2026 Umpires Manual · Crew of Two · Bases Loaded · Clean Hit to the Outfield · p. 95",
      text: "On a clean hit to the outfield with bases loaded, U1 observes the batter-runner's touch of third and moves to a position to rule on plays on the bases. PU stays with touches and plays at the plate."
    },
    "97": {
      reference: "2026 Umpires Manual · Crew of Two · Runners on First and Third · Right-Field Line Coverage · p. 96",
      text: "On a fly ball down the right-field line with a no-catch ruling, PU may move toward first for fair/foul and catch/no catch before returning toward the plate, while U1 handles the bases."
    },
    "98": {
      reference: "2026 Umpires Manual · Crew of Two · Runners on Second and Third · Clean Hit to the Outfield · p. 103",
      text: "With runners on second and third, U1 is responsible for plays at any base involving the batter-runner. That includes a return throw to first on BR after the runners score."
    },
    "99": {
      reference: "2026 Umpires Manual · Crew of Two · Runner on Third · Fly Ball to Left-Center, Catch · p. 106",
      text: "PU moves to the best position possible to observe R3's tag up and returns to the plate for all plays there. U1 observes the other runner tagging up and has the plays on the bases."
    },
    "100": {
      reference: "2026 Umpires Manual · Crew of Two · Runner on Third · p. 106",
      text: "Initial Position: U1 will start in the C position. Since there is no runner on first base, U1 can work one or two steps deeper than normal in most instances."
    }
  }
};
